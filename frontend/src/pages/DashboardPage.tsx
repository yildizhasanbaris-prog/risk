...
export function DashboardPage() {
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => api.get('/dashboard/stats').then((r) => r.data as { totalReports: number; openActions: number; byStatus: Record<string, number>; morAlerts?: { id: number; reportNo: string; title: string; morDeadline: string }[] }),
  });
